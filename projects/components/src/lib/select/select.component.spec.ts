...
// @TODO: tests for required, disabled, formControl
...
fdescribe('SelectComponent', () => {
  ...
  describe('[native]', () => {
    @Component({template: '<ag-select [options]="options" [preselected]="preselected"></ag-select>'})
  ...
  describe('[hybrid]', () => {
    @Component({template: '<ag-select method="hybrid" [options]="options" [preselected]="preselected"></ag-select>'})
    class TestHostComponent {
      options: AgOption[] = OPTIONS;
      preselected: string;
    }
  ...
  describe('[autocomplete]', () => {
    ...
    it('should select new value on click on label if search text is the same of the suggestion value', () => {
      hostFixture.detectChanges();
      selectDebugger = getSelectDebugger();
      const selectInstance: SelectComponent = selectDebugger.componentInstance;
      const selectElementDOM: HTMLSelectElement = selectDebugger.nativeElement;
    ...
    it(`should prevent a new selection on click on label if search text doesn't match any option value`, () => {
      hostFixture.detectChanges();
      selectDebugger = getSelectDebugger();
      const selectInstance: SelectComponent = selectDebugger.componentInstance;
      const selectElementDOM: HTMLSelectElement = selectDebugger.nativeElement;
