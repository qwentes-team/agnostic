...
describe('CheckboxComponent', () => {
  ...
  describe('[name]', () => {
    ...
    class TestHostChildComponent {}

    beforeEach(() => setupBeforeEachTestWithHostComponent(TestHostChildComponent));
    ...
    describe('[value]', () => {
      ...
      it('should bind value', () => {
        ...
        expect(checkboxDebugger.nativeElement.querySelector('.ag-checkbox__input').getAttribute('value')).toBe(
          'valore'
        );
      });
    });
